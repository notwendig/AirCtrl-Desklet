...
REQUIRED = ROOT_FILES + (
    ...
    "src/common/automation_example.hpp.in",
    "src/server/CMakeLists.txt",
    "src/server/main.cpp", "src/server/server.cpp", "src/server/server.h",
    "src/server/automation.cpp", "src/server/automation.h",
    ...
    "examples/automation.lua", "tests/test_server_automation.cpp", "tests/test_coap.cpp",
