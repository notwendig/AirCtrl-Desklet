...
class RepositoryTests(unittest.TestCase):
    ...
    def test_server_client_install_contract(self):
        ...
        self.assertIn("automation.cpp", server_cmake)
        self.assertIn("airctrl_lua", server_cmake)
        ...
        self.assertNotIn("airctrl_lua", client_cmake)
        self.assertNotIn("automation.cpp", client_cmake)
        ...
        automation = (self.root / "src" / "server" / "automation.cpp").read_text()
        self.assertNotIn("#include <Q", automation)
        self.assertIn("Lua-Automatik", automation)
        ...
        self.assertIn("LUA_USE_JUMPTABLE=0", cmake)
