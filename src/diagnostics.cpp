...
const QHash<QString,QString> descriptions{
    ...
    {"wl", "Gemeldeter Wasserstand bzw. Wasserstatus. Die Skala ist geräteabhängig; 100 ist hier keine gesicherte Messung der Füllmenge in Prozent."},
    ...
    {"err", "Geräteeigener Fehler-/Statuscode. Die Codezuordnung ist modell- und firmwareabhängig; daraus wird hier kein gesicherter Wartungsalarm abgeleitet."},
