...
const QHash<QString,QString> descriptions{
    ...
    {"fltsts1", "Verbleibende Betriebsstunden bis zum HEPA-Filterwechsel (AC2729: A3), kein Prozentwert. Lokale Desklet-Vorwarnung bei 1–120 h; Wechsel fällig bei 0 h."},
    {"fltsts2", "Verbleibende Betriebsstunden bis zum Aktivkohlefilterwechsel (AC2729: C7), kein Prozentwert. Lokale Desklet-Vorwarnung bei 1–120 h; Wechsel fällig bei 0 h."},
    {"wicksts", "Verbleibende Betriebsstunden bis zum Austausch des Befeuchtungsdochts (AC2729: F1), nicht bis zur Reinigung (F0). Lokale Desklet-Vorwarnung bei 1–120 h; Wechsel fällig bei 0 h."},
    ...
    {"err", "Geräteeigener Fehler-/Statuscode. Beim AC2729: 0xC100 (49408) = Wasser fehlt, 0xC001/0xC003 (49153/49155) = Vorfilter reinigen (Referenzintegration). 0xC054 (49236) wurde zusammen mit A3/C7/F1-Wechselhinweisen und positiven Reststunden beobachtet; die Einzelbits sind nicht gesichert zugeordnet. Aus diesem Code allein wird kein gesicherter Wartungsalarm abgeleitet: Filterwarnungen verwenden die Reststundenzähler und eine lokale 120-h-Grenze."},
